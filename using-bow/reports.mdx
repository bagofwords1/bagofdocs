...
Type your question in the prompt box and hit enter. The agent will analyze your request, pull relevant [context](/core/context), apply [instructions](/using-bow/instructions), and return results.
