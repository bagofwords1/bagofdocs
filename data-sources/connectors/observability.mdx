...
description: "Connect Splunk, Elasticsearch, OpenSearch, Jaeger, Zabbix, Prometheus and AWS Cost Explorer so the agent can investigate logs, traces, metrics and spend"
icon: "activity"
---
