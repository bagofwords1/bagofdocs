...
<Note>
  This page is about how a **connection** reaches a data source. For how people sign in **to Bag of words** — auth modes, OIDC and Entra ID, Google, and LDAP — see [Sign-in and SSO](/sign-in-and-sso).
</Note>
