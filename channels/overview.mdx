...
description: "Bring the Bag of words analyst to messaging tools and connect your own applications with OAuth"
...
<CardGroup cols={2}>
  ...
  <Card title="OAuth Apps" icon="key-round" href="/channels/oauth-apps">
    Let your own applications sign users in to BOW and call the BOW API on their behalf.
  </Card>
</CardGroup>
...
<Note>
  All channels and OAuth apps are configured by an admin under **Settings → Channels** in BOW.
</Note>