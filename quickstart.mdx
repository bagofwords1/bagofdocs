...
<CardGroup cols={2}>
  <Card title="How agents work" icon="brain" href="/">
    Learn about the governed reasoning loop and Knowledge Harness
  </Card>
  <Card title="Manage agents" icon="layers" href="/agents/overview">
    Configure the data, tools, files, instructions, and evals for every run
  </Card>
</CardGroup>
